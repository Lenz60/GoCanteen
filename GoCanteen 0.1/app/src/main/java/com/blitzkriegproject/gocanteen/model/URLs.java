...
public class URLs {
    ...
    public static final String URL_ORDER = "http://192.168.1.100/api.php?apicall=order";
    public static final String URL_NOTIF= "http://192.168.1.100/api.php?apicall=order=notification";
